...
impl<'a> Arguments<'a> {
    ...
    pub fn new_v1(pieces: &'a [&'a str],
        ...
        Arguments(ArgumentsInt::V1(ArgumentsV1 {
            pieces: pieces,
            fmt: None,
            args: args
        }))
    ...
    /// This function creates a new arguments structure from a closure
    #[doc(hidden)] #[inline]
    pub fn new_v2(closure: &'a Fn(&mut Formatter)->Result) -> Arguments<'a> {
        Arguments(ArgumentsInt::V2(closure))
    }
}

#[derive(Copy, Clone)]
struct ArgumentsV1<'a> {
...
#[stable(feature = "rust1", since = "1.0.0")]
#[derive(Copy, Clone)]
pub struct Arguments<'a>(ArgumentsInt<'a>);
...
// V2 Functions
impl<'a> Formatter<'a> {
    /// Reset the formatter to the default state in preparation for an argument
    #[doc(hidden)]
    #[unstable(feature = "fmt_internals", reason = "internal to format_args!",
               issue = "0")]
    pub fn reset(&mut self, flags: u32, align: Alignment) {
        self.fill = ' ';
        self.align = align;
        self.flags = flags;
        self.width = None;
    ...
    #[unstable(feature = "fmt_internals", reason = "internal to format_args!",
               issue = "0")]
    pub fn set_precision(&mut self, val: usize) {
        self.precision = Some(val);
    }
}
